      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 overflow-auto">
          <main className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <h1 className="text-3xl font-bold mb-8 gradient-text">Editar Evento</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select value={eventCategory} onValueChange={setEventCategory} required>
                        ...
                        <SelectContent>
                          <SelectItem value="Música" className="cursor-pointer">
                            Música
                          </SelectItem>
                          <SelectItem value="Comedia" className="cursor-pointer">
                            Comedia
                          </SelectItem>
                          <SelectItem value="Tecnología" className="cursor-pointer">
                            Tecnología
                          </SelectItem>
                          <SelectItem value="Deportes" className="cursor-pointer">
                            Deportes
                          </SelectItem>
                          <SelectItem value="Teatro" className="cursor-pointer">
                            Teatro
                          </SelectItem>
                        </SelectContent>
                      </Select>
              ...
              {/* Date & Location - Same as create page */}
              <Card>
                <CardHeader>
              ...
              {/* Areas - Same structure as create page */}
              <Card>
                <CardHeader>
