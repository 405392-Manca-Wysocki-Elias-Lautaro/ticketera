...
export default function AdminEventsPage() {
    ...
    //     if (eventCard) {
    //         eventCard.classList.add("disintegrate")
    //         setTimeout(() => {
    ...
    if (isLoadingAuth || !user || !RoleUtils.isAdmin(user) || isLoadingEvents || !events) {
        return (
                ...
                {events?.length === 0 ? (
                    ...
                    <div className="space-y-4 pb-5">
                        {events.map((event) => {
                            ...
                            return (
                                <Card key={event.id} data-event-id={event.id} className="hover:shadow-lg transition-shadow">
                                            ...
                                            <div className="flex-1 space-y-4">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                                                    ...
                                                    <div className="flex items-center gap-2 text-muted-foreground">
                                                        ...
                                                        <span>{event.totalAvailableTickets} disponibles</span>
                                                    </div>
                                                </div>
