...
import { Search, Ticket, User, LogOut, Settings, LayoutDashboard, Calendar, Home } from "lucide-react"
...
export function Navbar() {
  ...
  const logoHref = user?.role === "admin" ? "/admin" : user?.role === "staff" ? "/staff" : "/dashboard"

  const isAdminPage = pathname?.startsWith("/admin")
  const searchPlaceholder = isAdminPage ? "Buscar en mis eventos..." : "Buscar eventos..."
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <Link href={logoHref} className="flex items-center gap-2 shrink-0">
              <Image src="/logo.png" alt="Ticketera" width={32} height={32} className="h-8 w-8" />
              <span className="font-bold text-lg gradient-text hidden sm:inline">Ticketera</span>
            </Link>
