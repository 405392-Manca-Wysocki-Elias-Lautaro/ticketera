...
-- Índices útiles
CREATE INDEX IF NOT EXISTS idx_holds_occurrence_id ON tickets.holds(occurrence_id);
...
CREATE INDEX IF NOT EXISTS idx_tickets_occurrence_id ON tickets.tickets(occurrence_id);
